              ...
              for (
                ...
                for (
                  ...
                  for (
                    ...
                    (e.variableWidth &&
                      r[f].props.style &&
                      (o = r[f].props.style.width),
                    !(f >= r.length));
                    f += 1
                  )
                    p.push(
                      c.default.cloneElement(r[f], {
                        key: 100 * s + 10 * d + f,
                        tabIndex: -1,
                        style: {
                  ...
                  l.push(
                    c.default.createElement("div", { key: 10 * s + d }, p)
                  );
                }
                e.variableWidth
                  ? i.push(
                  ...
                  : i.push(c.default.createElement("div", { key: s }, l));
              }
              if ("unslick" === e) {
                var v = "regular slider " + (this.props.className || "");
                return c.default.createElement("div", { className: v }, i);
              }
              return (
    ...
    function(e, t, n) {
      (function(t) {
        !(function(t, n) {
          ...
          function i(e) {
            for (
              var t = ["top", "right", "bottom", "left"], r = {}, i = 0, o = t;
              i < o.length;
              i++
            ) {
              var s = o[i],
          ...
          function s(e) {
            ...
            if (
              ("border-box" === s.boxSizing &&
                (Math.round(p + c) !== t && (p -= r(s, "left", "right") + c),
                Math.round(f + d) !== o && (f -= r(s, "top", "bottom") + d)),
              !a(e))
            ) {
            ...
            return u(l.left, l.top, p, f);
          }
          function a(e) {
            return e === b(e).document.documentElement;
          }
          function l(e) {
            return p ? (T(e) ? o(e) : s(e)) : k;
          }
          function c(e) {
            var t = e.x,
              n = e.y,
          ...
          var d = (function() {
            ...
            w = (function() {
              function t() {
                (this.connected_ = !1),
                  ...
                  (this.refresh = e(this.refresh.bind(this), y));
              }
              return (
            ...
            E = "undefined" != typeof WeakMap ? new WeakMap() : new d(),
            M = (function() {
              function e(t) {
          ...
          var L = (function() {
            return "undefined" != typeof f.ResizeObserver
              ? f.ResizeObserver
              : M;
          })();
          return L;
